...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function render() {
        ...
        taxis.forEach(t => {
            ...
            totalSeatsOpen += Math.max(0, t.capacity - occupiedCount);
        });
